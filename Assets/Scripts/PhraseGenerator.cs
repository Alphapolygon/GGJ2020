...
namespace GGJ2020
{
    public class PhraseGenerator : MonoBehaviour
    {
        ...
        private string[] feelingStrings = { "Just {0}.", "I feel {0}!", "That makes me {0}!", "{0}.", "I go through.","I endure.","I bear.", "I suffer.","I perceive.","Are you serious?","Get of my back!","Don't point at me!", "You're crazy!", "Don't look at me!","Don't judge me!","You're just like your mother!","You're just like your father!","Don't talk down to me!", "This is pointless!","I could be {0}, but I'm not!", "I'm never {0}","What are you talking about?","I don't understand?","You're just trying to make me {0}!"};
