...
namespace GGJ2020
{
    public class PhraseGenerator : MonoBehaviour
    {
        ...
        private string[] verbs = { "does dishes", "makes sweet love to me", "harrasses me", "sleeps with my friends","talks to me","help me with my work","take care of the kids","take out the trash","does chores","smiles to me","drinks too much","spends all of our money","spends too much time on the phone","is always working","massages me","spends time with the kids", "watches tv during meals", "is jealous", "is a Trump supporter", "is mad at me", "is watching too much porn", "does stuff I want to do","opens doors to me","helps me","watches tv without me", "hangs the toilet paper wrong way", "walks the dog","breathing too loud","spends too much time on the toilet", "likes pineapple on pizza","snores too loud", "leaves the toilet seat up","is a communist","likes javascript", "thinks outside the box", "likes cats", "likes dogs", "drives a BMW", "drives an AUDI", "has night terros", "is horny","lies to me","tells dad jokes","it too serious","hates me","kisses me","hugs me","touches me","has restless leg syndrome","goes to the gym","looks at my ass","looks wierd","holds my hand","yells at me","ignores me" };
